import React, { useEffect, useState, useCallback, type CSSProperties, type ReactNode } from "react";
...
export function Layout({ children }: { children: ReactNode }) {
  ...
  useEffect(() => { applyDocumentBranding(publicSettings, "Dashboard"); }, [publicSettings]);
  ...
  return (
    <SidebarProvider open={sidebarOpen} onOpenChange={handleToggleSidebar} style={style}>
