...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "relative overflow-hidden rounded-[1.75rem] border border-slate-200/70 bg-white/85 text-card-foreground shadow-[0_24px_50px_-28px_rgba(15,23,42,0.35)] backdrop-blur-sm",
      className
    )}
    {...props}
  />
