      ...
      <div className="space-y-4 p-4 md:p-6">
        ...
        <section className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          {[
            ...
            <div key={item.label} className="flex flex-col overflow-hidden rounded-xl border border-slate-200/80 bg-white shadow-sm">
        ...
        <div className="grid gap-4 lg:grid-cols-7">
          ...
          {/* Monthly trend chart */}
          <Card className="rounded-xl border border-slate-200/80 bg-white shadow-sm lg:col-span-5">
            <CardHeader className="flex flex-row items-center gap-2 border-b border-slate-100 px-4 py-3">
